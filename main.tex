...
Researcher working at the intersection of \textbf{neural interfaces}, \textbf{physiological sensing}, \textbf{learning}, and \textbf{control}. Current work spans \textbf{EEG-based brain--computer interfaces} and \textbf{robust output-feedback model predictive control}.
...
\begin{itemize}
    ...
    \item Investigated how \textbf{oculomotor behaviors---including fixation, saccades, and smooth pursuit---}
    affected gaze-tracking precision and temporal response, including interactions with
    device-side signal filtering during locomotion.

    \item Designed human-subject experiments and analyzed gaze-tracking accuracy,
    calibration drift, and motion-dependent sensing error across multiple mixed-reality devices.
...
\begin{itemize}
    ...
    \item Contributed perception, multimodal state-estimation, and navigation components to
    \textbf{Eklavya 6.0}, IIT Kharagpur's autonomous ground vehicle that finished
    \textbf{Runner-Up at IGVC 2018}.
...
\hfill 2026 -- Present
\\
\textit{Independent Brain--Computer Interface Project}
...
Time-Series Modeling, Spectral Analysis, Digital Filtering,
Wearable/Inertial Signal Processing
