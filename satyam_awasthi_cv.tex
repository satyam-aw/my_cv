...
\ifincludeattachments
    ...
    \noindent
    \centering
    \includegraphics[width=\linewidth, height=\textheight, keepaspectratio]{transcripts/kgp_transcript_full.jpg}
    \end{landscape}
    ...
    \includepdf[pages=-]{transcripts/official_transcript_ucsb.pdf}
\fi 
